...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3 Max/CrealityV427 - BLTouch"
...
#define STRING_CONFIG_H_AUTHOR "Paul Gasper" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "OPEnS Ender-3 Max (OS 1.0.0)"
